  ...
  return (
    <ChartContext.Provider value={{ config }}>
      ...
      >
        ...
        <RechartsPrimitives.ResponsiveContainer>{children}</RechartsPrimitives.ResponsiveContainer>
      </div>
...
const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<typeof RechartsPrimitives.Tooltip> &
    React.ComponentProps<"div"> & {
      hideLabel?: boolean
...
const ChartLegendContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div"> &
    Pick<RechartsPrimitives.LegendProps, "payload" | "verticalAlign"> & {
      hideIcon?: boolean
      nameKey?: string
    }
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  if (key in config || (payloadPayload && configLabelKey in payloadPayload)) {
    ...
    configLabelKey = Object.keys(payloadPayload)[0] as string
  }
